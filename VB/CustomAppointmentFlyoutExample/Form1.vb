...
Namespace CustomAppointmentFlyoutExample
    Partial Public Class Form1
        ...
        Public Sub New()
            Me.fontStorage = New FontStorage()
            InitializeComponent()
            InitializeScheduler()
        End Sub

        Private Sub InitializeScheduler()
            DataHelper.InitResources(Me.schedulerStorage1)
            DataHelper.InitAppointments(Me.schedulerStorage1)
...
'            #End Region ' #OptionsFlyout
        ...
        Private Sub chkBtnTooltips_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles chkBtnTooltips.CheckedChanged
...
'                #End Region ' #AllowDisplayAppointmentFlyout
            ...
            End If
        End Sub
        Private Sub chkBtnAppointmentFlyoutShowing_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles chkBtnAppointmentFlyoutShowing.CheckedChanged
        ...
        Private Sub chkBtnCustomizeAppointmentFlyout_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles chkBtnCustomizeAppointmentFlyout.CheckedChanged
        ...
        Private Sub chkBtnCustomDrawAppointmentFlyoutSubject_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles chkBtnCustomDrawAppointmentFlyoutSubject.CheckedChanged
    ...
    Public Class FontStorage
        ...
        Private ReadOnly subjectFont_Renamed As Font

        Private ReadOnly statusFont_Renamed As Font

        Private ReadOnly subjectAppearanceFont_Renamed As Font

        Public Sub New()
            Me.subjectFont_Renamed = New Font("Tahoma", 10, FontStyle.Bold)
            Me.statusFont_Renamed = New Font("Tahoma", 8, FontStyle.Bold)
            Me.subjectAppearanceFont_Renamed = New Font("Arial", 24)
        End Sub
